...
class pyparsing_test:
    """
    namespace class for classes useful in writing unit handtests
    """

    class reset_pyparsing_context:
        """
        Context manager to be used when writing unit handtests that modify pyparsing config values:
        - packrat parsing
