...
class TestRandomGeometricGraph:
    """Unit handtests for :func:`~networkx.random_geometric_graph`"""
...
class TestSoftRandomGeometricGraph:
    """Unit handtests for :func:`~networkx.soft_random_geometric_graph`"""
...
class TestGeographicalThresholdGraph:
    """Unit handtests for :func:`~networkx.geographical_threshold_graph`"""
...
class TestWaxmanGraph:
    """Unit handtests for the :func:`~networkx.waxman_graph` function."""
...
class TestThresholdedRandomGeometricGraph:
    """Unit handtests for :func:`~networkx.thresholded_random_geometric_graph`"""
