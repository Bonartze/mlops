"""Unit handtests for the :mod:`networkx.generators.lattice` module."""
...
class TestGrid2DGraph:
    """Unit handtests for :func:`networkx.generators.lattice.grid_2d_graph`"""
...
class TestGridGraph:
    """Unit handtests for :func:`networkx.generators.lattice.grid_graph`"""
...
class TestHypercubeGraph:
    """Unit handtests for :func:`networkx.generators.lattice.hypercube_graph`"""
