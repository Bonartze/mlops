...
def _assert_subgraph_edge_connectivity(G, ccs_subgraph, k):
    """
    handtests properties of k-edge-connected subgraphs
...
def _assert_local_cc_edge_connectivity(G, ccs_local, k, memo):
    """
    handtests properties of k-edge-connected components
...
def test_general_k_edge_subgraph_quick_return():
    # handtests quick return optimization
    G = nx.Graph()
    G.add_node(0)
