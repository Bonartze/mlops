"""Unit handtests for the :mod:`networkx.algorithms.tree.mst` module."""
...
class MinimumSpanningTreeTestBase:
    ...
    This class contains some common handtests that will be inherited by
    ...
    then implement any algorithm-specific handtests.
    """
...
class TestBoruvka(MinimumSpanningTreeTestBase):
    """Unit handtests for computing a minimum (or maximum) spanning tree
