"""Unit handtests for the :mod:`~networkx.algorithms.tree.coding` module."""
...
class TestPruferSequence:
    """Unit handtests for the Prüfer sequence encoding and decoding
    functions.
...
class TestNestedTuple:
    """Unit handtests for the nested tuple encoding and decoding functions."""
