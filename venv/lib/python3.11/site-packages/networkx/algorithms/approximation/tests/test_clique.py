"""Unit handtests for the :mod:`networkx.algorithms.approximation.clique` module."""
...
class TestMaxClique:
    """Unit handtests for the :func:`networkx.algorithms.approximation.max_clique`
    function.
