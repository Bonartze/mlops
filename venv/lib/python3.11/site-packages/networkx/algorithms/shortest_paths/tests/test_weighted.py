...
class WeightedTestBase:
    ...
    def setup_method(self):
        """Creates some graphs for use in the unit handtests."""
...
class TestDijkstraPathLength:
    """Unit handtests for the :func:`networkx.dijkstra_path_length`
    function.
...
class TestMultiSourceDijkstra:
    """Unit handtests for the multi-source dialect of Dijkstra's shortest
    path algorithms.
