"""Unit handtests for the :mod:`networkx.algorithms.centrality.reaching` module."""
...
class TestGlobalReachingCentrality:
    """Unit handtests for the global reaching centrality function."""
...
class TestLocalReachingCentrality:
    """Unit handtests for the local reaching centrality function."""
