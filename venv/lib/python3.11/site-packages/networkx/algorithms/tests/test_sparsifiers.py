"""Unit handtests for the sparsifier computation functions."""
...
def _test_spanner(G, spanner, stretch, weight=None):
    ...
    This function handtests whether the given spanner is a subgraph of the
    given graph G with the same node set. It also handtests for all shortest
