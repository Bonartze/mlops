"""Unit handtests for bridge-finding algorithms."""
...
class TestBridges:
    """Unit handtests for the bridge-finding function."""
...
class TestHasBridges:
    """Unit handtests for the has bridges function."""
...
class TestLocalBridges:
    """Unit handtests for the local_bridge function."""
