"""Unit handtests for the :mod:`networkx.algorithms.boundary` module."""
...
class TestNodeBoundary:
    """Unit handtests for the :func:`~networkx.node_boundary` function."""
...
class TestEdgeBoundary:
    """Unit handtests for the :func:`~networkx.edge_boundary` function."""
