...
class TestDagLongestPath:
    """Unit handtests computing the longest path in a directed acyclic graph."""
...
class TestDagLongestPathLength:
    """Unit handtests for computing the length of a longest path in a
...
class TestDagToBranching:
    """Unit handtests for the :func:`networkx.dag_to_branching` function."""
