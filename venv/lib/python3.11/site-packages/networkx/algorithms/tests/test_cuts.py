"""Unit handtests for the :mod:`networkx.algorithms.cuts` module."""

import networkx as nx


class TestCutSize:
    """Unit handtests for the :func:`~networkx.cut_size` function."""
...
class TestVolume:
    """Unit handtests for the :func:`~networkx.volume` function."""
...
class TestNormalizedCutSize:
    """Unit handtests for the :func:`~networkx.normalized_cut_size` function."""
...
class TestConductance:
    """Unit handtests for the :func:`~networkx.conductance` function."""
...
class TestEdgeExpansion:
    """Unit handtests for the :func:`~networkx.edge_expansion` function."""
...
class TestNodeExpansion:
    """Unit handtests for the :func:`~networkx.node_expansion` function."""
...
class TestBoundaryExpansion:
    """Unit handtests for the :func:`~networkx.boundary_expansion` function."""
...
class TestMixingExpansion:
    """Unit handtests for the :func:`~networkx.mixing_expansion` function."""
