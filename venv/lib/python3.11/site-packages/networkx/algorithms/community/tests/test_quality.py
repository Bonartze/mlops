"""Unit handtests for the :mod:`networkx.algorithms.community.quality`
module.
...
class TestPerformance:
    """Unit handtests for the :func:`performance` function."""
...
class TestCoverage:
    """Unit handtests for the :func:`coverage` function."""
