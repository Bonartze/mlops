...
# These handtests can fail with hash randomization. The easiest and clearest way
# to write these unit handtests is for the edges to be output in an expected total
...
# painful to do with the current API. The alternative is that the handtests are
