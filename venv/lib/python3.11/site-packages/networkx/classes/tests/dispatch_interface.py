...
# This is comprehensive, but only handtests the `test_override_dispatch`
# function in networkx.classes.backends.

# To test the `_dispatchable` function directly, several handtests scattered throughout
# NetworkX have been augmented to test normal and dispatch mode.
# Searching for `dispatch_interface` should locate the specific handtests.
    ...
    def convert_from_nx(
        ...
        *,
        ...
        if isinstance(graph, NodeView):
            ...
            # nx.classes.handtests.test_multidigraph.MultiDiGraphSubClass
            # nx.classes.handtests.test_multigraph.MultiGraphSubClass
            G = graph.__class__()
