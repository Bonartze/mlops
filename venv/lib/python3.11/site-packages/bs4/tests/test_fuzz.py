...
@pytest.mark.skipif(not fully_fuzzable, reason="Prerequisites for fuzz handtests are not installed.")
class TestFuzz(object):
    ...
    # older handtests. I'm not sure what to do about this, but I may
    # retire old handtests after a time.
