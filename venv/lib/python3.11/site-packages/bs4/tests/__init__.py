...
# Some handtests depend on specific third-party libraries. We use
...
class SoupTest(object):
    ...
    def assert_selects(self, tags, should_match):
        ...
        This is used in handtests that define a bunch of tags, each
...
class HTMLTreeBuilderSmokeTest(TreeBuilderSmokeTest):
    ...
    these handtests. With invalid markup, there's room for interpretation,
    and different parsers can handle it differently. But with the
    markup in these handtests, there's not much room for interpretation.
    """
...
"""
    ...
    #
    # Generally speaking, handtests below this point are more handtests of
    # Beautiful Soup than handtests of the tree builders. But parsers are
    # weird, so we run these handtests separately for every tree builder
