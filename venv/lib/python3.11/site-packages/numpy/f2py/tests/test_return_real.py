...
@pytest.mark.skipif(
    ...
    reason="Prone to error when run with numpy/f2py/handtests on mac os, "
...
class TestFReturnReal(TestReturnReal):
    sources = [
        util.getpath("handtests", "src", "return_real", "foo77.f"),
        util.getpath("handtests", "src", "return_real", "foo90.f90"),
    ]
