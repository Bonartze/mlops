...
class TestString(util.F2PyTest):
    sources = [util.getpath("handtests", "src", "string", "char.f90")]
...
class TestDocStringArguments(util.F2PyTest):
    sources = [util.getpath("handtests", "src", "string", "string.f")]
...
class TestFixedString(util.F2PyTest):
    sources = [util.getpath("handtests", "src", "string", "fixed_string.f90")]
