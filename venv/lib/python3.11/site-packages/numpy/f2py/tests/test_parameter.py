...
class TestParameters(util.F2PyTest):
    ...
    sources = [
        util.getpath("handtests", "src", "parameter", "constant_real.f90"),
        util.getpath("handtests", "src", "parameter", "constant_integer.f90"),
        util.getpath("handtests", "src", "parameter", "constant_both.f90"),
        util.getpath("handtests", "src", "parameter", "constant_compound.f90"),
        util.getpath("handtests", "src", "parameter", "constant_non_compound.f90"),
    ]
