...
def setup_module():
    ...
    if wrap is None:
        ...
        src = [
            util.getpath("handtests", "src", "array_from_pyobj", "wrapmodule.c"),
...
# and several handtests fail as the alignment flag can be randomly true or fals
# when numpy gains an aligned allocator the handtests could be enabled again
#
