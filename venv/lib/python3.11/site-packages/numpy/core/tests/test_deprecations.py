...
class _DeprecationTestCase:
    ...
    def setup_method(self):
        ...
        # try to keep the handtests cleanly giving only the right warning type.
...
class TestFromStringAndFileInvalidData(_DeprecationTestCase):
    # 2019-06-08, 1.17.0
    # Tests should be moved to real handtests when deprecation is done.
...
class TestLoadtxtParseIntsViaFloat(_DeprecationTestCase):
    ...
    # The handtests:
    #   * numpy/lib/handtests/test_loadtxt.py::test_integer_signs
    #   * lib/handtests/test_loadtxt.py::test_implicit_cast_float_to_int_fails
