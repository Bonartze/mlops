...
class TestMinMax:
    def test_minmax_blocked(self):
        # simd handtests on max/min, test all alignments, slow but important
...
class TestAbsoluteNegative:
    def test_abs_neg_blocked(self):
        # simd handtests on abs, test all alignments for vz + 2 * (vs - 1) + 1
...
class TestSpecialMethods:
    ...
    def test_ufunc_override_mro(self):
        ...
        # Check our counter works, so we can trust handtests below.
        res = np.multiply(c, a)
    ...
    def test_ufunc_override_with_super(self):
        ...
        # some handtests with a non-ndarray subclass
        a = np.arange(5.)
        b = B()
        ...
        # regression check for gh-9102 -- handtests ufunc.reduce implicitly.
        ...
        assert_(c is b)
        assert_(c.info, {'inputs': [0], 'outputs': [0]})
        # simple explicit handtests of reduce, accumulate, reduceat
...
class TestComplexFunctions:
    ...
    def test_loss_of_precision(self, dtype):
        ...
        if dtype is np.longcomplex:
            ...
            # So, give more leeway for long complex handtests here:
