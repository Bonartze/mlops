...
class TestUfunc:
    ...
    def test_pickle_name_is_qualname(self):
        # This handtests that a simplification of our ufunc pickle code will
    ...
    def test_sum_where(self):
        # More extensive handtests done in test_reduction_with_where.
    ...
    def test_axes_argument(self):
        ...
        # basic handtests on inputs (outputs tested below with matrix_multiply).
        c = inner1d(a, b)
    ...
    def test_reduce_zero_axis(self):
        ...
        # handtests are simpler because accumulate doesn't accept multiple axes.
    ...
    def test_reducelike_output_needs_identical_cast(self):
        ...
        # handtests that this is not rejected directly.
...
def test_trivial_loop_invalid_cast():
    # This handtests the fast-path "invalid cast", see gh-19904.
    with pytest.raises(TypeError,
