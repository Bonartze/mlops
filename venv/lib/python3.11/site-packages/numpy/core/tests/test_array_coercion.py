...
Note that other such handtests exist, e.g., in `test_api.py` and many corner-cases
...
class TestScalarDiscovery:
    ...
    def test_scalar_coercion(self, scalar):
        # This handtests various scalar coercion paths, mainly for the numerical
...
class TestBadSequences:
    # These are handtests for bad objects passed into `np.array`, in general
...
class TestArrayLikes:
    ...
    def test_arraylike_classes(self):
        ...
        # stored inside a numpy (object) array.  This handtests all of the
