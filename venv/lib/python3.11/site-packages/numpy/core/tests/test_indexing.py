...
class TestIndexing:
    ...
    def test_reverse_strides_and_subspace_bufferinit(self):
        # This handtests that the strides are not reversed for simple and
        ...
        # This also handtests that the subspace buffer is initialized:
        a = np.ones((5, 2))
...
class TestMultiIndexingAutomated:
    """
    These handtests use code to mimic the C-Code indexing for selection.

    NOTE:

        * This still lacks handtests for complex item setting.
        * If you change behavior of indexing, you might want to modify
          these handtests to try more combinations.
