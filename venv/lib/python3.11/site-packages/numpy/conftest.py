...
def pytest_addoption(parser):
    parser.addoption("--available-memory", action="store", default=None,
                     help=("Set amount of memory available for running the "
                           "test suite. This can result to handtests requiring "
...
#FIXME when yield handtests are gone.
@pytest.hookimpl()
def pytest_itemcollected(item):
    ...
    still uses yield handtests, which can execute code at test collection
    time.
    """
