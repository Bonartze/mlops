...
class LinalgCase:
    def __init__(self, name, a, b, tags=set()):
        ...
        name, the operands a and b, and a set of tags to filter the handtests
        """
...
class _TestNorm2D(_TestNormBase):
    ...
    # and run the handtests using np.matrix in matrixlib.handtests.test_matrix_linalg.
    array = np.array
...
# Separate definitions so we can use them for matrix handtests.
...
class TestCholesky:
    # TODO: are there no other handtests for cholesky?
