...
# _foo1 and _foo2 are used in some handtests in TestVectorize.
...
class TestInterp:
    ...
    def sc(self, request):
        """ scale function used by the below handtests """
...
class TestPercentile:
    ...
    def test_nat_basic(self, dtype, pos):
        ...
        # NaT and NaN should behave the same, do basic handtests for NaT:
...
class TestQuantile:
    ...
    def V(self, x, y, alpha):
        # Identification function used in several handtests.
        return (x >= y) - alpha
    ...
    def test_quantile_monotonic(self, method):
        ...
        # Also handtests that the boundary values are not mishandled.
