...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    See Also
    --------
    assert_array_equal: handtests objects for equality
...
def rundocs(filename=None, raise_on_error=True):
    ...
    argument to the ``test()`` call. For example, to run all handtests (including
...
def _assert_valid_refcount(op):
    ...
    Used in a few regression handtests.
    """
    if not HAS_REFCOUNT:
        return True
...
class suppress_warnings:
    ...
    handtests might need to see the warning. Additionally it allows easier
...
def _no_tracing(func):
    ...
    Needed in handtests that check refcounting, otherwise the tracing itself
