...
"""Tests for testing utils (psutil.handtests namespace)."""
...
# ===================================================================
# --- Unit handtests for test utilities.
# ===================================================================
...
class TestSyncTestUtils(PsutilTestCase):
    def test_wait_for_pid(self):
        ...
        with mock.patch('psutil.handtests.retry.__iter__', return_value=iter([0])):
...
class TestFSTestUtils(PsutilTestCase):
    ...
    def test_safe_rmpath(self):
        ...
        with mock.patch(
            'psutil.handtests.os.stat', side_effect=OSError(errno.EINVAL, "")
        ) as m:
