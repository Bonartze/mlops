...
and save the values to data files for use in handtests. Using mpmath directly in
handtests would take too long.
...
def main():
    ...
    filename = os.path.join(pwd, '..', 'handtests', 'data', 'local',
                            'wright_bessel.txt')
