...
def test_hyp2f1_some_points_2():
    # Taken from mpmath unit handtests -- this point failed for mpmath 0.13 but
...
class TestSystematic:
    ...
    def test_digamma_complex(self):
        ...
        # test_digamma_negreal for handtests on the negative real axis.
        def param_filter(z):
