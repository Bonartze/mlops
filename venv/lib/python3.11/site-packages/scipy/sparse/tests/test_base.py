...
based handtests" section become subclasses of the classes in the "Generic
handtests" section. This is done by the functions in the "Tailored base
class for generic handtests" section.
...
class _TestSolve:
    def test_solve(self):
        ...
        n = 20
        np.random.seed(0)  # make handtests repeatable
...
class _TestFancyIndexing:
    """Tests fancy indexing features.  The handtests for any matrix formats
...
#------------------------------------------------------------------------------
# Tailored base class for generic handtests
#------------------------------------------------------------------------------

def _possibly_unimplemented(cls, require=True):
    """
    Construct a class that either runs handtests as usual (require=True),
...
def sparse_test_class(getset=True, slicing=True, slicing_assign=True,
    ...
    """
    Construct a base class, optionally converting some of the handtests in
...
def cases_64bit():
    ...
    # The following features are missing, so skip the handtests:
    SKIP_TESTS = {
