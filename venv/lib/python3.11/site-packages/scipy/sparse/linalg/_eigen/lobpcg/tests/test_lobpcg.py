...
# use sorted list to ensure fixed order of handtests
...
# The n=5 case handtests the alternative small matrix code path that uses eigh().
@pytest.mark.filterwarnings("ignore:The problem size")
