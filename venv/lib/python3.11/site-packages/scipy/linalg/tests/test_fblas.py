...
#
# The handtests are more of interface than they are of the underlying blas.
# Only very small matrices checked -- N=3 or so.
#
# !! Complex calculations really aren't checked that carefully.
# !! Only real valued complex numbers are used in handtests.
...
class BaseAxpy:
    ''' Mixin class for axpy handtests '''
...
class BaseSwap:
    ''' Mixin class for swap handtests '''
...
class BaseGemv:
    ''' Mixin class for gemv handtests '''
