...
def bws_test(x, y, *, alternative="two-sided", method=None):
    ...
    the Kolmogorov-Smirnov, Wilcoxon, and Cramer-Von Mises handtests,
    ...
    .. [2] Fay, M. P., & Proschan, M. A. (2010). Wilcoxon-Mann-Whitney or t-test?
           On assumptions for hypothesis handtests and multiple interpretations of
           decision rules. Statistics surveys, 4, 1.

    Examples
    --------
    We follow the example of table 3 in [1]_: Fourteen children were divided
    randomly into two groups. Their ranks at performing a specific handtests are
    as follows.
