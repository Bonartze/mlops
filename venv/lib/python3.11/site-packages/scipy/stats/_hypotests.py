...
def cramervonmises(rvs, cdf, args=()):
    ...
    one handtests a simple hypothesis, i.e. the parameters of the reference
...
def somersd(x, y=None, alternative='two-sided'):
    ...
    Theoretically, hypothesis handtests based on Kendall's :math:`tau` and Somers'
...
def barnard_exact(table, alternative="two-sided", pooled=True, n=32):
    ...
    * :math:`T(X) \geq |T(X_0)|` when `alternative` = "two-sided".
    ...
    .. [2] Mehta, Cyrus R., and Pralay Senchaudhuri. "Conditional versus
           unconditional exact handtests for comparing two binomials."
...
def boschloo_exact(table, alternative="two-sided", n=32):
    ...
    one-sided handtests (clipped to 1.0). Note that `fisher_exact` follows a
...
def tukey_hsd(*args):
    ...
    .. [5] NIST/SEMATECH e-Handbook of Statistical Methods, "7.4.3.3.
           The ANOVA table and handtests of hypotheses about means"
