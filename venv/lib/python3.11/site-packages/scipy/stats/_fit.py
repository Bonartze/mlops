...
def goodness_of_fit(dist, data, *, known_params=None, fit_params=None,
    ...
    of which correspond with various Anderson-Darling handtests, Lilliefors' test,
    ...
    *Traditional goodness of fit handtests*
    ...
    *Anti-Pattern*
    ...
    .. [2] W. Stute, W. G. Manteiga, and M. P. Quindimil (1993).
           "Bootstrap based goodness-of-fit-handtests." Metrika 40.1: 243-256.
