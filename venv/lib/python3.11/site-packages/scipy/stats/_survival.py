...
def ecdf(sample: npt.ArrayLike | CensoredData) -> ECDFResult:
    ...
    **Right-censored Data**
    ...
    tested. Five handtests concluded because the fanbelt being tested broke, but
    the remaining handtests concluded for other reasons (e.g. the study ran out of
    ...
    end of the handtests are unknown, but they are known to exceed the values
