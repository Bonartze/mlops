...
These handtests currently check only/mostly for serious errors and exceptions,
...
DECIMAL = 5  # specify the precision of the handtests  # increased from 0 to 5
_IS_32BIT = (sys.maxsize < 2**32)

# Sets of handtests to skip.
...
def test_rvs_gh2069_regression():
    # Regression handtests for gh-2069.  In scipy 0.17 and earlier,
    # these handtests would fail.
    #
...
def check_distribution_rvs(dist, args, alpha, rvs):
    ...
    # test from scipy.stats.handtests
