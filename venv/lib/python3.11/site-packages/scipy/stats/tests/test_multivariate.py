...
class TestInvwishart:
    ...
    def test_sample_mean(self):
        ...
        for dim in [1, 5]:
            ...
            ntests = dim*(dim + 1)//2
            fail_rate = 0.01 / ntests  # correct for multiple handtests
...
class TestMultivariateT:
    ...
    # These handtests were created by running vpa(mvtpdf(...)) in MATLAB. The
    # function takes no `mu` parameter. The handtests were run as
    #
