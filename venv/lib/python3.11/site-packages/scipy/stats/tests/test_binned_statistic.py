...
class TestBinnedStatistic:
    ...
    def test_big_number_std(self):
        # handtests for numerical stability of std calculation
    ...
    def test_empty_bins_std(self):
        # handtests that std returns gives nan for empty bins
        x = self.x
        u = self.u
    ...
    def test_dd_binned_statistic_result(self):
        # NOTE: handtests the reuse of bin_edges from previous call
