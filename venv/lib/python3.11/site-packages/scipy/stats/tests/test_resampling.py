...
class TestMonteCarloHypothesisTest:
    ...
    def test_against_normality_tests(self, hypotest, alternative, a):
        # test that monte_carlo_test can reproduce pvalue of normality handtests
...
class TestPermutationTest:
    ...
    # To get reasonable accuracy, these next three handtests are somewhat slow.
    ...
    # into three handtests, each testing a particular combination of the three
    # parameters.

    def test_randomized_test_against_exact_both(self):
        # check that the randomized and exact handtests agree to reasonable
    ...
    def test_vectorized_nsamp_ptype_both(self, axis):
        ...
        # and random permutation handtests approximate SciPy's asymptotic pvalues
    ...
    def test_finite_precision_statistic(self):
        ...
        # Compare against other exact correlation handtests using R corr.test
        # options(digits=16)
        # x = c(1, 2, 4, 3)
        # y = c(2, 4, 6, 8)
