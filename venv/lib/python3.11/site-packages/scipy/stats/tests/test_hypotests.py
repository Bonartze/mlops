...
class TestMannWhitneyU:
    ...
    # this has been corrected and the handtests have been refactored for
    # compactness, but otherwise the handtests are unchanged.
...
class TestSomersD(_TestPythranFunc):
    ...
    def test_like_kendalltau(self):
        # All handtests correspond with one in test_stats.py `test_kendalltau`
...
class TestBarnardExact:
    """Some handtests to show that barnard_exact() works correctly."""
...
class TestBoschlooExact:
    """Some handtests to show that boschloo_exact() works correctly."""
    ...
    def test_against_fisher_exact(self, alternative):
        ...
        # p-value of `fisher_exact` (for one-sided handtests). See gh-15345.
        tbl = [[2, 7], [8, 2]]
...
class TestPoissonMeansTest:
    ...
    @pytest.mark.parametrize("c1, n1, c2, n2, p_expect, alt, d", (
        ...
        # additional handtests were created.
