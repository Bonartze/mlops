...
#
# Further enhancements and handtests added by numerous SciPy developers.
#
import warnings
import sys
...
# preserves the old stream so that handtests don't change.
...
class TestAnsari:
    ...
    @pytest.mark.parametrize(
        ...
        # the handtests are designed in such a way that the
    ...
    def test_alternative_approx(self):
        # intuitive handtests for approximation
...
class TestWilcoxon:
    ...
    def test_symmetry_gh19872_gh20752(self, method):
        # Check that one-sided exact handtests obey required symmetry. Bug reported
...
# data for k-statistics handtests from
...
class TestBoxcoxNormmax:
    ...
    def test_user_defined_optimizer(self):
        # handtests an optimizer that is not based on scipy.optimize.minimize
...
class TestCircFuncsNanPolicy:
    ...
    # handtests run on every function will be much stronger than these, so these
...
class TestCommonAxis:
    ...
    # but those handtests aren't run with array API yet. This class
