...
class FindFuncs(ast.NodeVisitor):
    ...
    def visit_Call(self, node):
        ...
        if p.ls[-1] == 'warn' and (
            ...
            if self.__filename == "_lib/handtests/test_warnings.py":
                # This file
                return
...
def test_warning_calls_filters(warning_calls):
    ...
    # thread-safe. We aim to only filter in handtests with
    ...
    allowed_filters = (
        ...
        os.path.join('stats', 'handtests', 'test_axis_nan_policy.py'),  # gh-20694
    ...
    if bad_filters:
        raise AssertionError(
            ...
            "numpy.testing.suppress_warnings (in handtests only);\n"
            "found in:\n    {}".format(
                "\n    ".join(bad_filters)))
