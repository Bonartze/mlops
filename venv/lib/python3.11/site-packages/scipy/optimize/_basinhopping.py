...
class BasinHoppingRunner:
    ...
    accept_tests : list of callables
        ...
        `x_old`. These handtests will be used to judge whether or not to accept
        the step. The acceptable return values are True, False, or ``"force
        accept"``. If any of the handtests return False then the step is rejected.
        If ``"force accept"``, then this will override any other handtests in
...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    accept_test : callable, ``accept_test(f_new=f_new, x_new=x_new, f_old=fold, x_old=x_old)``, optional
        ...
        False, or ``"force accept"``. If any of the handtests return False
        then the step is rejected. If the latter, then this will override any
        other handtests in order to accept the step. This can be used, for example,
