# Dual annealing unit handtests implementation.
# Copyright (c) 2018 Sylvain Gubian <sylvain.gubian@pmi.com>,
# Yang Xiang <yang.xiang@pmi.com>
# Author: Sylvain Gubian, PMP S.A.
"""
Unit handtests for the dual annealing global optimizer
"""
...
class TestDualAnnealing:
    ...
    def setup_method(self):
        # A function that returns always infinity for initialization handtests
    ...
    def func(self, x, args=()):
        # Using Rastrigin function for performing handtests
        if args:
            shift = args
        else:
            shift = 0
