...
class QAPCommonTests:
    """
    Base class for `quadratic_assignment` handtests.
    """
...
class Test2opt(QAPCommonTests):
    ...
    def test_partial_guess(self):
        ...
        assert_equal(res2.nit, n*(n+1)/2)      # handtests each swap exactly once
        assert_equal(res3.nit, (n-2)*(n-1)/2)  # handtests free swaps exactly once
