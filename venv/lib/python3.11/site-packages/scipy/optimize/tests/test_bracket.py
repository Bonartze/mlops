...
class TestBracketMinimum:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                # Case 5:
                # Similar to Case 1 above, but handtests default values of xl0 and xr0.
                None,
                0.3,
                None,
                None,
            ...
            (   # Case 6:
                # Similar to Case 2 above, but handtests default values of xl0 and xr0.
                None,
                1.95,
                None,
                0.3,
            ...
            (
                # Case 7:
                # Similar to Case 3 above, but handtests default values of xl0 and xr0.
                None,
                3.25,
                None,
                None,
            ...
            (
                # Case 8:
                # Similar to Case 4 above, but handtests default values of xl0 and xr0.
                None,
                4.5,
                None,
                -26.3,
