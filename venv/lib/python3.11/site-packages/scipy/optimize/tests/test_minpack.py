"""
Unit handtests for optimization routines from minpack.py.
"""
import warnings
import pytest
...
# Function and Jacobian for handtests of solvers for systems of nonlinear
# equations
...
class TestCurveFit:
    ...
    def test_func_is_classmethod(self):
        class test_self:
            """This class handtests if curve_fit passes the correct number of
