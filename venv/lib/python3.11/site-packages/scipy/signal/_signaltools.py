...
def choose_conv_method(in1, in2, mode='full', measure=False):
    ...
    * This function is most inaccurate for 1D convolutions that take between 1
    ...
    handtests were of similar quality (and even slightly better) than the same
    handtests performed on the machine to tune this function's numbers (a mid-2014
...
def _filtfilt_gust(b, a, x, axis=-1, irlen=None):
    ...
    caller.  The intended use of these return values is in unit handtests.
