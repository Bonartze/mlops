"""Unit handtests for module `_short_time_fft`.

This file's structure loosely groups the handtests into the following sequential
categories:
...
3. Test algorithmic properties of STFT/ISTFT. Some handtests were ported from
   ``test_spectral.py``.
