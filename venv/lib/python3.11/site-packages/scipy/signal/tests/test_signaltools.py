...
class TestConvolve(_TestConvolve):
    ...
    def test_convolve_method(self, n=100):
        ...
        for t1, t2, mode in args:
            ...
            # threshold to have handtests pass.
    ...
    def test_convolve_method_large_input(self):
        ...
        for n in [10, 20, 50, 51, 52, 53, 54, 60, 62]:
            ...
            # issue #6076 has more detail, hopefully more handtests after resolved
            if n < 50:
...
class TestResample:
    ...
    def test_resample_methods(self, method, ext, padtype):
        ...
        # More handtests of fft method (Master 0.18.1 fails these)
        if method == 'fft':
...
class TestHilbert:
    ...
    def test_hilbert_axisN(self):
        # handtests for axis and N arguments
...
class TestPartialFractionExpansion:
    ...
    def test_resiude_degenerate(self):
        # Several handtests for zero numerator and denominator.
...
class TestSOSFilt:
    ...
    # The test_rank* handtests are pulled from _TestLinearFilter
