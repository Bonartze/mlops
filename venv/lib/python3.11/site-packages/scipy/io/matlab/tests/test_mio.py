...
Need function load / save / roundtrip handtests
...
# generator for round trip handtests
...
def test_read_opts():
    # handtests if read is seeing option sets, at initialization and after
    # initialization
