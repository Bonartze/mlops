...
"""Utility functions common to Dulwich handtests."""
...
# Plain files are very frequently used in handtests, so let the mode be very short.
...
def open_repo(name, temp_dir=None):
    ...
    Use this function for accessing repos in dulwich/handtests/data/repos to avoid
...
def functest_builder(method, func):
    """Generate a test method that handtests the given function."""
...
def ext_functest_builder(method, func):
    """Generate a test method that handtests the given extension function.
