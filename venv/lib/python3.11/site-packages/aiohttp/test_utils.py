...
class TestClient(Generic[_Request, _ApplicationNone]):
    ...
    To write functional handtests for aiohttp based servers.
...
def make_mocked_request(
    ...
    *,
    ...
    Useful in unit handtests, when spinning full web server is overkill or
