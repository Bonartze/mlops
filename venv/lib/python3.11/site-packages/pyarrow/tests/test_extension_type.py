...
class TinyIntType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.int8(), 'pyarrow.handtests.TinyIntType')
...
class IntegerType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.int64(), 'pyarrow.handtests.IntegerType')
...
class IntegerEmbeddedType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(IntegerType(), 'pyarrow.handtests.IntegerType')
...
class ExampleUuidType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.binary(16), 'pyarrow.handtests.ExampleUuidType')
...
class ExampleUuidType2(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.binary(16), 'pyarrow.handtests.ExampleUuidType2')
...
class LabelType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.string(), 'pyarrow.handtests.LabelType')
...
class ParamExtType(pa.ExtensionType):
    ...
    def __init__(self, width):
        self._width = width
        super().__init__(pa.binary(width), 'pyarrow.handtests.ParamExtType')
...
class MyStructType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(self.storage_type, 'pyarrow.handtests.MyStructType')
...
class MyListType(pa.ExtensionType):
    ...
    def __init__(self, storage_type):
        ...
        super().__init__(storage_type, 'pyarrow.handtests.MyListType')
...
class MyFixedListType(pa.ExtensionType):
    ...
    def __init__(self, storage_type):
        ...
        super().__init__(storage_type, 'pyarrow.handtests.MyFixedListType')
...
class AnnotatedType(pa.ExtensionType):
    ...
    def __init__(self, storage_type, annotation):
        ...
        super().__init__(storage_type, 'pyarrow.handtests.AnnotatedType')
...
def test_ext_type_basics():
    ty = ExampleUuidType()
    assert ty.extension_name == "pyarrow.handtests.ExampleUuidType"


def test_ext_type_str():
    ty = IntegerType()
    expected = "extension<pyarrow.handtests.IntegerType<IntegerType>>"
...
def test_extension_to_pandas_storage_type(registered_period_type):
    ...
    import pandas as pd
    # Skip handtests for 2.0.x, See: GH-35821
    if (
