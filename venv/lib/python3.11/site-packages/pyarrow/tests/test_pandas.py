...
# Marks all of the handtests in this module
...
class TestConvertMetadata:
    """
    Conversion handtests for Pandas metadata & indices.
    """
...
class TestConvertPrimitiveTypes:
    """
    Conversion handtests for primitive (e.g. numeric) types.
    """
...
class TestConvertDateTimeLikeTypes:
    """
    Conversion handtests for datetime- and timestamp-like types (date64, etc.).
    """
...
# ----------------------------------------------------------------------
# Conversion handtests for string and binary types.
...
class TestConvertListTypes:
    """
    Conversion handtests for list<> types.
    """
...
class TestConvertStructTypes:
    """
    Conversion handtests for struct types.
    """
...
class TestConvertMisc:
    """
    Miscellaneous conversion handtests.
    """
...
def test_safe_cast_from_float_with_nans_to_int():
    # TODO(kszucs): write handtests for creating Date32 and Date64 arrays, see
...
# ----------------------------------------------------------------------
# Some nested array handtests array handtests
...
# ----------------------------------------------------------------------
# Array protocol in pandas conversions handtests
...
class DummyExtensionType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.int64(),
                         'pyarrow.handtests.test_pandas.DummyExtensionType')
...
class MyCustomIntegerType(pa.ExtensionType):
    ...
    def __init__(self):
        super().__init__(pa.int64(),
                         'pyarrow.handtests.test_pandas.MyCustomIntegerType')
...
# ----------------------------------------------------------------------
# Legacy metadata compatibility handtests
