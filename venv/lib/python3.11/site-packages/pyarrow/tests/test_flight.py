...
class GetInfoFlightServer(FlightServerBase):
    """A Flight server that handtests GetFlightInfo."""
...
class ListActionsFlightServer(FlightServerBase):
    """A Flight server that handtests ListActions."""
...
class HeaderAuthFlightServer(FlightServerBase):
    """A Flight server that handtests with basic token authentication. """
...
class ArbitraryHeadersFlightServer(FlightServerBase):
    """A Flight server that handtests multiple arbitrary headers."""
