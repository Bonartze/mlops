...
class TestDataFrameSelectReindex:
    # These are specific reindex-based handtests; other indexing handtests should go in
    # test_indexing
    ...
    def test_reindex_with_multi_index(self):
        ...
        # handtests for reindexing a multi-indexed DataFrame with a new MultiIndex
        #
