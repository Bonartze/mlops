"""
This module handtests the functionality of StringArray and ArrowStringArray.
Tests for the str accessors are in pandas/handtests/strings/test_string_array.py
"""
import numpy as np
import pytest
