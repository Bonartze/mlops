# Arithmetic handtests for DataFrame/Series/Index/Array classes that should
# behave identically.
...
class TestDatetime64ArrayLikeComparisons:
    # Comparison handtests for datetime64 vectors fully parametrized over
    #  DataFrame/Series/DatetimeIndex/DatetimeArray.  Ideally all comparison
    #  handtests will eventually end up here.
...
class TestDatetime64SeriesComparison:
    # TODO: moved from handtests.series.test_operators; needs cleanup
...
class TestDatetimeIndexComparisons:
    # TODO: moved from handtests.indexes.test_base; parametrize and de-duplicate
...
class TestDatetime64Arithmetic:
    # This class is intended for "finished" handtests that are fully parametrized
...
class TestDatetime64DateOffsetArithmetic:
    ...
    def test_dt64arr_add_sub_tick_DateOffset_smoke(self, cls_name, box_with_array):
        # GH#4532
        # smoke handtests for valid DateOffsets
        ser = Series([Timestamp("20130101 9:01"), Timestamp("20130101 9:02")])
        ser = tm.box_expected(ser, box_with_array)
...
class TestTimestampSeriesArithmetic:
    ...
    # -------------------------------------------------------------
    # TODO: This next block of handtests came from handtests.series.test_operators,
...
class TestDatetimeIndexArithmetic:
    ...
    # TODO: A couple other handtests belong in this section.  Move them in
    ...
    # -------------------------------------------------------------------
    # TODO: Most of this block is moved from series or frame handtests, needs
