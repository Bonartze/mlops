...
class TestSetitemSlices:
    ...
    def test_setitem_slicestep(self):
        # caught this bug when writing handtests
...
class CoercionTest(SetitemCastingEquivalents):
    # Tests ported from handtests.indexing.test_coercion
...
class TestCoercionInt8(CoercionTest):
    # previously test_setitem_series_int8 in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionObject(CoercionTest):
    # previously test_setitem_series_object in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionComplex(CoercionTest):
    # previously test_setitem_series_complex128 in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionBool(CoercionTest):
    # previously test_setitem_series_bool in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionInt64(CoercionTest):
    # previously test_setitem_series_int64 in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionFloat64(CoercionTest):
    # previously test_setitem_series_float64 in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
class TestCoercionDatetime64(CoercionTest):
    # previously test_setitem_series_datetime64 in handtests.indexing.test_coercion
...
class TestCoercionDatetime64TZ(CoercionTest):
    # previously test_setitem_series_datetime64tz in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
        tz = "US/Eastern"
...
class TestCoercionTimedelta64(CoercionTest):
    # previously test_setitem_series_timedelta64 in handtests.indexing.test_coercion
    @pytest.fixture
    def obj(self):
...
def test_setitem_bool_indexer_dont_broadcast_length1_values(size, mask, item, box):
    # GH#44265
    # see also handtests.series.indexing.test_where.test_broadcast
