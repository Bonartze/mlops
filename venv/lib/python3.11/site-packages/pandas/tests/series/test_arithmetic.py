...
class TestSeriesArithmetic:
    # Some of these may end up in handtests/arithmetic, but are not yet sorted
...
# ------------------------------------------------------------------
# Unsorted
#  These arithmetic handtests were previously in other files, eventually
#  should be parametrized and put into handtests.arithmetic
