...
# this file contains BlockManager specific handtests
# TODO(ArrayManager) factor out interleave_dtype handtests
...
class TestIndexing:
    # Nosetests-style data-driven handtests.
    #
    ...
    #
    # NOTE: sparse (SparseBlock with fill_value != np.nan) fail a lot of handtests
    #       and are disabled.
