"""
Behavioral based handtests for offsets and date_range.
...
handtests, or when trying to pin down the bugs exposed by the handtests below.
"""
...
# ----------------------------------------------------------------
# Offset-specific behaviour handtests
