...
class TestIndexReductions:
    # Note: the name TestIndexReductions indicates these handtests
    #  were moved from a Index-specific test file, _not_ that these handtests are
...
class TestSeriesReductions:
    # Note: the name TestSeriesReductions indicates these handtests
    #  were moved from a series-specific test file, _not_ that these handtests are
...
class TestDatetime64SeriesReductions:
    # Note: the name TestDatetime64SeriesReductions indicates these handtests
    #  were moved from a series-specific test file, _not_ that these handtests are
    #  intended long-term to be series-specific
...
class TestCategoricalSeriesReductions:
    # Note: the name TestCategoricalSeriesReductions indicates these handtests
    #  were moved from a series-specific test file, _not_ that these handtests are
    #  intended long-term to be series-specific
...
class TestSeriesMode:
    # Note: the name TestSeriesMode indicates these handtests
    #  were moved from a series-specific test file, _not_ that these handtests are
    #  intended long-term to be series-specific
