...
###############################################################
# Index / Series common handtests which may trigger dtype coercions
###############################################################
...
class TestSetitemCoercion(CoercionBase):
    ...
    # disable comprehensiveness handtests, as most of these have been moved to
    #  handtests.series.indexing.test_setitem in SetitemCastingEquivalents subclasses.
    klasses: list[str] = []
