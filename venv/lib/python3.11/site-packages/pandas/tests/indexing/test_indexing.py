...
class TestFancy:
    ...
    def test_dups_fancy_indexing_across_dtypes(self):
        ...
        # GH#3509 smoke handtests for indexing with duplicate columns
        df.iloc[:, 4]
        result.iloc[:, 4]
...
class TestMisc:
    ...
    def test_rhs_alignment(self):
        # GH8258, handtests that both rows & columns are aligned to what is
        ...
        # run handtests with uniform dtypes
        run_tests(df, rhs, right_loc, right_iloc)

        # make frames multi-type & re-run handtests
