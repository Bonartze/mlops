...
def test_subset_chained_single_block_row(using_copy_on_write, using_array_manager):
    # not parametrizing this for dtype backend, since this explicitly handtests single block
...
# TODO add more handtests modifying the parent
...
# TODO add handtests for other indexing methods on the Series
