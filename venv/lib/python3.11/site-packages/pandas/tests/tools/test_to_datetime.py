...
class TestTimeConversionFormats:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # The 3 handtests below are locale-dependent.
...
class TestToDatetime:
    ...
    def test_error_iso_week_year(self, msg, s, _format, errors):
        ...
        # Therefore, the handtests only run when locale is not overwritten,
    ...
    def test_datetime_invalid_index(self, values, format):
        # GH24763
        # Not great to have logic in handtests, but this one's hard to
        # parametrise over
...
class TestToDatetimeUnit:
    ...
    def test_to_datetime_month_or_year_unit_int(self, cache, unit, item):
        # GH#50870 Note we have separate handtests that pd.Timestamp gets these right
    ...
    # TODO: this is moved from handtests.series.test_timeseries, may be redundant
