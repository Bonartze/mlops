...
class TestIndex(Base):
    ...
    def test_new_axis(self, index):
        # TODO: a bunch of scattered handtests check this deprecation is enforced.
    ...
    def test_drop_by_numeric_label_loc(self):
        # TODO: Parametrize numeric and str handtests after self.strIndex fixture
        index = Index([1, 2, 3])
...
class TestMixedIntIndex(Base):
    # Mostly the handtests from common.py for which the results differ
