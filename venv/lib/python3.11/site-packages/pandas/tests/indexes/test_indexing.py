"""
test_indexing handtests the following Index methods:
    __getitem__
    get_loc
    get_value
    __contains__
...
The corresponding handtests.indexes.[index_type].test_indexing files
contain handtests for the corresponding methods specific to those Index subclasses.
"""
import numpy as np
import pytest
