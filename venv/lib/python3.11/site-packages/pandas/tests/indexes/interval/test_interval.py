...
class TestIntervalIndex:
    ...
    def test_is_unique_interval(self, closed):
        """
        Interval specific handtests for is_unique in addition to base class handtests
        """
    ...
    def test_is_overlapping(self, start, shift, na_value, closed):
        # GH 23309
        # see test_interval_tree.py for extensive handtests; interface handtests here
