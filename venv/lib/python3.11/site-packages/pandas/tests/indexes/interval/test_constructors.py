...
class ConstructorTests:
    """
    Common handtests for all variations of IntervalIndex construction. Input data
...
class TestFromTuples(ConstructorTests):
    ...
    def get_kwargs_from_breaks(self, breaks, closed="right"):
        ...
        if tm.is_unsigned_integer_dtype(breaks):
            pytest.skip(f"{breaks.dtype} not relevant IntervalIndex.from_tuples handtests")
...
class TestClassConstructors(ConstructorTests):
    ...
    def get_kwargs_from_breaks(self, breaks, closed="right"):
        ...
        """
        if tm.is_unsigned_integer_dtype(breaks):
            pytest.skip(f"{breaks.dtype} not relevant for class constructor handtests")
