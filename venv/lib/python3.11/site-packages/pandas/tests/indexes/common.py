...
class Base:
    """
    Base class for index sub-class handtests.
    """
    ...
    def test_constructor_name_unhashable(self, simple_index):
        ...
        # See also same-named test in handtests.series.test_constructors
        idx = simple_index
    ...
    def test_map_dictlike(self, mapper, simple_index):
        ...
        if isinstance(idx, CategoricalIndex):
            ...
            #  CategoricalIndex.
            pytest.skip(f"skipping handtests for {type(idx)}")
...
class NumericBase(Base):
    """
    Base class for numeric index (incl. RangeIndex) sub-class handtests.
    """
