"""
The handtests in this package are to ensure the proper resultant dtypes of
set operations.
"""
...
class TestSetOps:
    # Set operation handtests shared by all indexes in the `index` fixture
...
def test_setop_with_categorical(index_flat, sort, method):
    # MultiIndex tested separately in handtests.indexes.multi.test_setops
    index = index_flat
