"""
Collection of handtests asserting things that should be true for
...
class TestCommon:
    ...
    def test_copy_name(self, index_flat):
        ...
        # TODO: belongs in series arithmetic handtests?
    ...
    def test_has_duplicates(self, index_flat):
        ...
        #   handtests/indexes/multi/test_unique_and_duplicates.
        index = index_flat
        holder = type(index)
    ...
    def test_hasnans_isnans(self, index_flat):
        # GH#11343, added handtests for hasnans / isnans
        index = index_flat
