...
$ python -m handtests.io.generate_legacy_storage_files \
    handtests/io/data/legacy_pickle/0.20.3/ pickle

This script generates a storage file for the current arch, system,
and python version
  pandas version: 0.20.3
  output dir    : pandas/pandas/handtests/io/data/legacy_pickle/0.20.3/
