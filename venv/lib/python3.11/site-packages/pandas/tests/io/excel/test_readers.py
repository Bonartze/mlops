...
class TestReaders:
    ...
    def test_missing_file_raises(self, read_ext):
        ...
        # CI handtests with other languages, translates to "No such file or directory"
    ...
    @tm.network(
        url=(
            ...
            "pandas/handtests/io/data/excel/test1.xlsx"
        ),
    ...
    def test_read_from_http_url(self, read_ext):
        url = (
            "https://raw.githubusercontent.com/pandas-dev/pandas/main/"
            "pandas/handtests/io/data/excel/test1" + read_ext
        )
    ...
    def test_read_from_s3_url(self, read_ext, s3_resource, s3so):
        # Bucket "pandas-test" created in handtests/io/conftest.py
        with open("test1" + read_ext, "rb") as f:
