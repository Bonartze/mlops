...
class BaseParser:
    ...
    def read_csv_check_warnings(
        ...
        # We need to check the stacklevel here instead of in the handtests
...
def csv_dir_path(datapath):
    """
    The directory path to the data files needed for parser handtests.
    """
...
def csv1(datapath):
    """
    The path to the data file "test1.csv" needed for parser handtests.
    """
