...
class BaseBlockManager(DataManager):
    ...
    def copy(self: T, deep: bool | None | Literal["all"] = True) -> T:
        ...
        if deep:
            # hit in e.g. handtests.io.json.test_pandas
    ...
    def take(
        ...
        BlockManager
        """
        # We have 6 handtests that get here with a slice
        indexer = (
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iset(
        ...
        #        can prob also fix the various if handtests for sparse/categorical
        ...
        if lib.is_integer(loc):
            # We have 6 handtests where loc is _not_ an int.
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    def get_slice(self, slobj: slice, axis: AxisInt = 0) -> SingleBlockManager:
        ...
        # so passing refs is not yet covered by the handtests
        block = type(blk)(array, placement=bp, ndim=1, refs=blk.refs)
