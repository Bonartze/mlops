    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def remove(self, key: str, where=None, start=None, stop=None) -> None:
        ...
        try:
            ...
            # In handtests we get here with ClosedFileError, TypeError, and
...
class DataCol(IndexCol):
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str):
        ...
        if self.dtype is None:
            # Note: in handtests we never have timedelta64 or datetime64,
...
class GenericFixed(Fixed):
    ...
    def write_array(
        ...
        # TODO: we only have a few handtests that get here, the only EA
...
class Table(Fixed):
    ...
    def _get_blocks_and_items(
        ...
        if len(data_columns):
            ...
            #  It is the case in all extant handtests, but NOT the case
...
def _get_data_and_dtype_name(data: ArrayLike):
    ...
    # For datetime64tz we need to drop the TZ in handtests TODO: why?
