...
def chdir_hydra_root(subdir: Optional[str] = None) -> None:
    ...
    used from unit handtests to make them runnable from anywhere in the tree.
    """
...
"""
    ...
    try:
        ...
        # some handtests are parsing the file output for more specialized testing.
        return file_str
    finally:
        os.chdir(orig_dir)
