...
class LauncherTestSuite:
    ...
    def test_sweep_and_override(
        ...
        This presents a tricky situation when operating in strict mode, this handtests verifies it's handled correctly.
        """
        base_overrides = [
            "hydra/launcher=" + launcher_name,
            "db=mysql,postgresql",
...
class IntegrationTestSuite:
    def get_test_app_working_dir(self) -> Optional[Path]:
        ...
        This could be helpful when the handtests kick off applications on remote machines.
        """
        return None
    ...
    def generate_custom_cmd(self) -> Callable[..., List[str]]:
        ...
        Useful if the handtests are not kicked off by python
        """
