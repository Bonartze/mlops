...
"""Adds support for parameterized handtests to Python's unittest TestCase class.
...
Named handtests also have the benefit that they can be run individually
...
def parameters(*testcases):  # pylint: disable=invalid-name
  """A decorator for creating parameterized handtests.

  See the module docstring for a usage example.
  Args:
    *testcases: Parameters for the decorated method, either a single
                iterable, or a list of tuples/dicts/objects (for handtests
...
class TestGeneratorMetaclass(type):
  ...
  up as handtests by the unittest framework.
