...
###############################################################################
# Module-level variables for the handtests
def f(x, y=1):
...
###############################################################################
# Helper function for the handtests
...
def test_parallel_call_cached_function_defined_in_jupyter(
    ...
    # This handtests checks that this is no longer the case.
    ...
    for session_no in [0, 1]:
        ...
        # Preliminary sanity checks, and handtests checking that joblib properly
...
def _function_to_cache(a, b):
    # Just a place holder function to be mutated by handtests
    pass
