...
# A decorator to run handtests only when numpy is available
try:
    import numpy as np

    def with_numpy(func):
        """A decorator to skip handtests requiring numpy."""
        return func
...
# TODO: Turn this back on after refactoring yield based handtests in test_hashing
...
try:
    ...
    def with_memory_profiler(func):
        """A decorator to skip handtests requiring memory_profiler."""
        return func
