...
class MemmappingPool(PicklingPool):
    ...
    def _temp_folder(self):
        # Legacy property in handtests. could be removed if we refactored the
        # memmapping handtests. SHOULD ONLY BE USED IN TESTS!
        # We cache this property because it is called late in the handtests - at
